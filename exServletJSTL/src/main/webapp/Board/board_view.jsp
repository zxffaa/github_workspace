...
<script>
   function board_delete(){
	url="board_delete.do?page=${page}&idx=${bod.idx}";
...
<%@ include file="/Include/login_form.jsp" %>
         ...
         <tr>
           <td class="content">
             <p align="right"><font size="2" face="돋움">
              <a class="list" href="mailto:ein1027@nate.com">${bod.name}</a> / <font size="2" face="돋움">${bod.regdate.substring(0,10)} / ${bod.readcnt}번 읽음</font>
      ...
      <!-- 수정하기 -->
       <a href="board_modify.do?idx=${bod.idx}&page=${page}">
