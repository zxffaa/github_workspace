 ...
 <head><meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
   ...
   <script>
   	function guest_delete(){
   		var url="/Guest?cmd=guest_delete?idx=${dto.idx}";
...
<%@ include file="/Include/login_form.jsp" %>
      ...
      <font size="2">
       <!-- 목록보기 -->
       <a class="list" href="/Guest?cmd=guest_list">[글 목록]</a>&nbsp;&nbsp;
       <a class="list" href="/Guest?cmd=guest_modify?idx=${dto.idx}">[글 수정]</a>&nbsp;&nbsp;
       <a class="list" href="javascript:guest_delete()">[글 삭제]</a>&nbsp;&nbsp;
       <a class="list" href="/Guest?cmd=guest_write">[글 등록]</a>
