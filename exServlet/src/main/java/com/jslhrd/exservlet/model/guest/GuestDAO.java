...
public class GuestDAO {
	...
	/*
	 * public 반환타입 메소드이름(매개변수) { //반환타입 int row = 0; String sql="";
	 * 
	...
	public int guestCount(String search, String key) {
		// 반환타입
		int row = 0;
		String sql2 = "select count(*) as counter from tbl_guest where " + search + " like '%" + key + "%'";

		String sql = "select count(*) as counter from tbl_guest where " + search + " like ?";
